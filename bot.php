...
[['text' => "- channel -'", 'url' => "https://t.me/a66_6"]],
]]) 
]);
}
if ($chat_id == $group) {
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"⌁ Done Stoped Checker \n⌁ Checker Stoped List ".$ex[1]." 🔐",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' =>اضف حساب 
$info = json_decode(file_get_contents('info.json'),true);
$info["num".$ex[1]] = "off";
file_put_contents('info.json', json_encode($info));
}
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Send List ".$ex[1]." 📥",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "the channel", 'url' => "https://t.me/a66_6"]],]])]);
file_put_contents('mode', 'besso'.$ex[1]);
}
if (preg_match('/Delet - \d+/',$text)){
$ex = explode('Delet - ',$text);
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Delet List ".$ex[1]." 🗑",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "the channel", 'url' => "https://t.me/a66_6"]],]])]);
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"⌁ Done Delet User List 2 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
} else {
bot('sendMessage', ['chat_id' => $chat_id, 'text'=>"@$user : Already Exists.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
}
unlink('mode');
} 
...
bot('sendMessage', ['chat_id' => $chat_id,  'text' => "⌁ Done Delet User List 1 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}elseif($mode == 'besso1'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,  'text' => "⌁ Done Added Users To List 1 :\n" . countUsers($userT, "1") ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}
}}
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 2 : @$user" ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}elseif($mode == 'besso2'){
echo $mode;
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"@$user : ⌁ Done Pin.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
} else {
bot('sendMessage', ['chat_id' => $chat_id, 'text'=>"@$user : Already Exists.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);}
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 3 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}elseif($mode == 'besso3'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 4 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}elseif($mode == 'besso4'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 5 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
unlink('mode');
}elseif($mode == 'besso5'){
echo $mode;
...
$list = $list . "\n$i  ➧ @$user";
$i++;}}
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "• The All Users List ".$ex[1]." 📥 \n".$list ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
}
if (preg_match('/Clear list \d+/',$text)){
$ex = explode('Clear list ',$text);
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "Done Delete all Usernames List 1",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "channel",'url' => "https://t.me/a66_6"]],
]])]);
